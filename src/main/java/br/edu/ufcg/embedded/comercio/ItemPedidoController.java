...
public class ItemPedidoController {
    ...
    public String create(@Valid ItemPedido itemPedido, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid ItemPedido itemPedido, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, itemPedido);
	...
	void populateEditForm(Model uiModel, ItemPedido itemPedido) {
